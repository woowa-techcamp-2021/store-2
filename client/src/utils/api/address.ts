...
export const addAddress = ({ name, receiver, address, addressDetail }: IAddressState): Promise<AxiosResponse> =>
  request<IAddressState>('POST', '/api/address', { name, receiver, address, addressDetail });
